...
# Color files
PFILE="$HOME/dotfiles/i3/.config/polybar/colors.ini"
RFILE="$HOME/dotfiles/i3/.config/polybar/scripts/rofi/colors.rasi"
...
change_color() {
	...
	sed -i -e 's/background-alt = #.*/background-alt = #303030/g' $PFILE
